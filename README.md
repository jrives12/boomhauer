...
Within your desired Discord Channel, you will need to use one of the following commands.

| Command | Description |
|---------|-------------|
| /fish today | Get full report for current day (weather, tide, fish activity). |
| /fish daily | Get automatic morning report for the current day. |
| /fish tomorrow | Get automatic morning report for the next. |
| /fish time <start> <end> | Get forecast for custom time window. |
| /fish week | Weekly summary with best fishing days. |
| /fish set zip <zip> type <shore/boat/kayak> | Save your default fishing location + style. |
| /fish species <fish> | Get species-specific recommendations (tactics, conditions, bite windows). |
